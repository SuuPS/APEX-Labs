...
<template>
  ...
  <div style="padding: 20px; width: 80%">
    ...
    <a-typography-title :level="3">Лекарственные препараты</a-typography-title>
...
import { useMedicinalProducts } from "../../store/medicinalProducts/medicinalProductsStore.ts";

const { filteredDataSource, add, formState, value, columns, editableData, edit, save, cancel, deleteRow } = toRefs(useMedicinalProducts());
